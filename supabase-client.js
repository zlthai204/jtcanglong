...
(function(){
  ...
  async function load(){
    ...
    loading=true;
    try{
      const names=["sa_communes","sa_routes","sa_shippers","sa_shipper_routes","sa_off_records","sa_setup_records","sa_setup_entries","sa_setup_entry_routes","sa_paste_days","sa_vehicle_duty_records"];
      const res={};
